...
<html>
	...
	<body>
		<a href="#list-paymentType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-paymentType" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="type" title="${message(code: 'paymentType.type.label', default: 'Type')}" />
				...
				<g:each in="${paymentTypeInstanceList}" status="i" var="paymentTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: paymentTypeInstance, field: "type")}</td>
			...
			<div class="pagination">
				<g:paginate total="${paymentTypeInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
