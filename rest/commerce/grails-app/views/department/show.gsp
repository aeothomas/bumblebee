		...
		<div id="show-department" class="content scaffold-show" role="main">
			...
			<ol class="property-list department">
				...
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="department.code.label" default="Code" /></span>
					
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${departmentInstance}" field="code"/></span>
