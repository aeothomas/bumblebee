...
<html>
	...
	<body>
		<a href="#edit-merchant" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-merchant" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:merchantInstance, action:'update']" method="PUT" >
