	...
	<body>
		...
		<div id="show-employee" class="content scaffold-show" role="main">
			...
			<ol class="property-list employee">
				...
				<g:if test="${employeeInstance?.store}">
				<li class="fieldcontain">
					<span id="store-label" class="property-label"><g:message code="employee.store.label" default="Store" /></span>
					
						<span class="property-value" aria-labelledby="store-label"><g:link controller="store" action="show" id="${employeeInstance?.store?.id}">${employeeInstance?.store?.encodeAsHTML()}</g:link></span>
