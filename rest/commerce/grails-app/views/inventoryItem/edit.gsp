...
<html>
	...
	<body>
		<a href="#edit-inventoryItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-inventoryItem" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:inventoryItemInstance, action:'update']" method="PUT" >
