		...
		<div id="list-product" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="product.pricingType.label" default="Pricing Type" /></th>
					
						<g:sortableColumn property="cost" title="${message(code: 'product.cost.label', default: 'Cost')}" />
					
						<th><g:message code="product.department.label" default="Department" /></th>
				...
				<g:each in="${productInstanceList}" status="i" var="productInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: productInstance, field: "pricingType")}</td>
					
						<td>${fieldValue(bean: productInstance, field: "cost")}</td>
					
						<td>${fieldValue(bean: productInstance, field: "department")}</td>
